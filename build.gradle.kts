...
mod {
    ...
    val supplementaries_min_version: String by extra
    ...
    additional.add("supplementaries_min_version", provider { supplementaries_min_version })
}
